...
elseif ($acao == "config") :
    ...
    if (isset($_POST['atualiza_config'])) :
        ...
        $speedteste = addslashes($_POST['speedteste']);
        $renovar = addslashes($_POST['renovar']);
        $webview = addslashes($_POST['webview']);
        $webview1 = addslashes($_POST['webview1']);
        $webview2 = addslashes($_POST['webview2']);
