                    ...
                    <div class="mt-2 row">
                        <div class="col">
                            ...
                            <select name="flag" class="form-select">
                                ...
                                <option value="ch.png">(CHINA)</option>
                                <option value="fr.png">(FRANÇA)</option>
                                <option value="hk.png">(HONG KONG)</option>
                                <option value="in.png">(ÍNDIA)</option>
                                <option value="id.png">(INDONÉSIA)</option>
                                <option value="jp.png">(JAPÃO)</option>
                                <option value="lr.png">(LIBÉRIA)</option>
                                <option value="my.png">(MALÁSIA)</option>
                                <option value="mx.png">(MÉXICO)</option>
                                <option value="pr.png">(PARAGUAY)</option>
                                <option value="ph.png">(PHILIPPINES)</option>
                                <option value="uk.png">(REINO UNIDO)</option>
                                <option value="sg.png">(SINGAPORE)</option>
                                <option value="kr.png">(SOUTH KOREA)</option>
                                <option value="us.png">(U.S.A)</option>
                                <option value="vivo.png">(VIVO)</option>
                                <option value="claro.png">(CLARO)</option>
                                <option value="tim.png">(TIM)</option>
                                <option value="fluke.png">(FLUKE)</option>
                                <option value="oi.png">(OI)</option>
                            </select>
                        </div>
                        <div class="col">
                        ...
                        <div class="mt-2 row">
                            <div class="col">
                                ...
                                <select name="flag" class="form-select">
                                    <option value="br.png">(BRASIL)</option>
                                    <option value="ar.png">(ARGENTINA)</option>
                                    <option value="ca.png">(CANADÁ)</option>
                                    <option value="ch.png">(CHINA)</option>
                                    <option value="fr.png">(FRANÇA)</option>
                                    <option value="hk.png">(HONG KONG)</option>
                                    <option value="in.png">(ÍNDIA)</option>
                                    ...
                                    <option value="mx.png">(MÉXICO)</option>
                                    <option value="pr.png">(PARAGUAY)</option>
                                    <option value="ph.png">(PHILIPPINES)</optio>
                                    <option value="uk.png">(REINO UNIDO)</optio>
                                    <option value="sg.png">(SINGAPORE)</option>
                                    <option value="kr.png">(SOUTH KOREA)</optio>
                                    <option value="us.png">(U.S.A)</option>
                                 <?php
                                    if ($dados['FLAG'] == 'vivo') { ?>
                    ...
                    <div class="row mt-2">
                      ...
                      <div class="row mt-2">
                        <div class="col">
                            ...
                            <input type="text" name="whatsapp" class="form-control" value="<?= htmlspecialchars(getConfigUser('whatsapp', $uid)) ?>">
                       </div>
                        <div class="col">
                            <label for="">Telegram</label>
                            <input type="text" name="telegram" class="form-control" value="<?= htmlspecialchars(getConfigUser('telegram', $uid)) ?>">
                        </div>
                    </div>
                        ...
                        <div class="col">
                            ...
                            <input type="text" name="youtube" class="form-control" value="<?= htmlspecialchars(getConfigUser('youtube', $uid)) ?>">
                       </div>
                        <div class="col">
                            <label for="">SpeedTeste</label>
                            <input type="text" name="speedteste" class="form-control" value="<?= htmlspecialchars(getConfigUser('speedteste', $uid)) ?>">
                        </div>
                    </div>
                      ...
                      <div class="row mt-2">
                        <div class="col">
                            ...
                            <input type="text" name="renovar" class="form-control" value="<?= htmlspecialchars(getConfigUser('renovar', $uid)) ?>">
                       </div>
                        <div class="col">
                            <label for="">Webview?</label>
                            <input type="text" name="webview" class="form-control" value="<?= htmlspecialchars(getConfigUser('webview', $uid)) ?>">
                        </div>
                    </div>
                    
                      <div class="row mt-2">
                        <div class="col">
                            <label for="">Webview1?</label>
                            <input type="text" name="webview1" class="form-control" value="<?= htmlspecialchars(getConfigUser('webview1', $uid)) ?>">
                        </div>
                        <div class="col">
                            <label for="">Webview2?</label>
                            <input type="text" name="webview2" class="form-control" value="<?= htmlspecialchars(getConfigUser('webview2', $uid)) ?>">
                        </div>
                    </div>
