...
if (isset($_POST['btn_salvar'])) :
    ...
    $dados = array(
        ...
        'Whatsapp' => getConfigUser('whatsapp', $uid),
        'Telegram' => getConfigUser('telegram', $uid),
        'YouTube' => getConfigUser('youtube', $uid),
        'SpeedTeste' => getConfigUser('speedteste', $uid),
        'Renovar' => getConfigUser('renovar', $uid), 
        'Webview' => getConfigUser('webview', $uid), 
        'Webview1' => getConfigUser('webview1', $uid),
        'Webview2' => getConfigUser('webview2', $uid),
